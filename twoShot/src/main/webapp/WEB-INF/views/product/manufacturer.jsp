...
<c:set var="string1" value="${manufacturerid}"/>
<c:set var="length" value="${fn:length(string1)-2}"/>

<c:set var="manufacturer" value="${fn:substring(string1, 0, length)}" />

	<!--banner-->
	<div class="banner-top">
		<div class="container">
			<h1>${manufacturer}</h1>  <!-- 각 매장 -->
			<em></em>
			<h2>
				HANDMADE
			</h2>
...
<link rel="stylesheet" href="//maxcdn.bootstrapcdn.com/font-awesome/4.3.0/css/font-awesome.min.css">
	<form name="manufactureSearch" method="get" action="/product/${manufacturerid}Search">
		<div class="container">
			<div class="row">
  ...
  <!-- Pagination -->
        <div class="row text-center">
         <div class="col-lg-12">
            ...
            http://localhost:8081/product/thecustomid?
            category=Oxford
            &color=brown
            &size=225
            &size=265
         ...
         <c:if test="${pageMaker.prev}">
            <li>
               <a href="${manufacturerid}?page=${pageMaker.startPage - 1}">&laquo;</a>
            </li>
         </c:if>
         ...
         <c:forEach begin="${pageMaker.startPage}" end="${pageMaker.endPage}" var="idx">
            <li 
               <c:out value="${pageMaker.cri.page == idx?'class =active': ''}"/>>
                <a href="${manufacturerid}?page=${idx}">${idx}</a>
<%--                 <a href="#" onclick="getpage(${idx});">${idx}</a> --%>
         ...
         <c:if test="${pageMaker.next && pageMaker.endPage > 0}">
            <li>
               <a href="${manufacturerid}?page=${pageMaker.endPage + 1}">&raquo;</a>
            </li>
         </c:if>
...
<!-- 검색 값들을 유지하게 해주는 데이터 -->
	<form name="searchCondition" method="get" >
		<input type="hidden" name="category" value="${searchCriteria.category}"/>
		<input type="hidden" name="color" value="${searchCriteria.color}"/>
		<input type="hidden" name="size" value="${searchCriteria.size}"/>
		<input type="hidden" name="price" value="${searchCriteria.price}"/>	  
	</form>

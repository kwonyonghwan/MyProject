								...
								<div class="aa-myaccount-register">
									...
									<form role="form" method="post" class="aa-login-form">
										...
										<i class="glyphicon glyphicon-user"></i>
										 ...
										 <input type="text" id="memberid" name="memberid" va
											placeholder="UserId"  value="${mVO.memberid}"/>
										...
										<input type="password" id="memberpw" name="memberpw"
											placeholder="Password" value="${mVO.memberpw}"> 
										...
										<input type="checkbox" id="female" name="female" value="female"> <br>
										...
										<input type="text" id="memberaddress" name="memberaddress"
											value="${mVO.memberaddress}">
											
											 <label for="memberfootwidth">발 가로길이
											 <i class="glyphicon glyphicon-resize-vertical"></i>
											 </label>
											  <input type="text" id="memberfootwidth" name="memberfootwidth" value="${mVO.memberfootwidth}">
											
											
											 <label for="memberfootheight">발 세로길이
											<i class="glyphicon glyphicon-resize-horizontal"></i>
											</label> 
											
											<input type="text"
											id="memberfootheight" name="memberfootheight"  value="${mVO.memberfootheight}">
											
											
											 <label for="memberfootperimeter">발 둘레
											<i class="glyphicon glyphicon-repeat"></i>
											</label> 
											
											<input type="text"
											id="memberfootperimeter" name="memberfootperimeter" value="${mVO.memberfootperimeter}">
										...
										<button type="submit" class="aa-browse-btn"
											onclick="window.open('popup.jsp','팝업 ','width=532,height=520,toolbar=no,location=no,status=no,menubar=no,scrollbars=yes,resizable=no,left=150,top=100')">회원가입</button>
									</form>
